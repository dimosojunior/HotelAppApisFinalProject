...
#-------------RESET PASSWORD
    ...
    #-------------------- PRODUCTS-------------
    path('ViewHotelProductsPage/', views.ViewHotelProductsPage, name='ViewHotelProductsPage'),
    ...
    #----------------UPLOAD PRODUCTS----------------------------------------
    path('UploadHotelProductsHomePage/', views.UploadHotelProductsHomePage, name='UploadHotelProductsHomePage'),
    ...
    path('HotelOrderPageByProductCategory/', views.HotelOrderPageByProductCategory, name='HotelOrderPageByProductCategory'),
    path('GetHotelOrderPage/<int:id>/', views.GetHotelOrderPage, name='GetHotelOrderPage'),
    path('ViewHotelOrderItemsPageByCategory/<int:id>/', views.ViewHotelOrderItemsPageByCategory, name='ViewHotelOrderItemsPageByCategory'),
    path('DeleteHotelOrderByCategory/<int:id>/', views.DeleteHotelOrderByCategory, name='DeleteHotelOrderByCategory'),
    ...
    #-------------COUNT ORDERS----------------
    path('CountAllHotelOrdersPage/', views.CountAllHotelOrdersPage, name='CountAllHotelOrdersPage'),
    ...
    #--------------PRINT ORDERS-------------------
    path('PrintHotelOrders/', views.PrintHotelOrders, name='PrintHotelOrders'),
    path('PrintHotelOrdersByCategory/<int:id>/', views.PrintHotelOrdersByCategory, name='PrintHotelOrdersByCategory'),
    path('PrintHotelRoomsOrder/', views.PrintHotelRoomsOrder, name='PrintHotelRoomsOrder'),

    


    #----------UPLOAD TABLES--------------------
    path('UploadHotelTablesPage/', views.UploadHotelTablesPage, name='UploadHotelTablesPage'),
]