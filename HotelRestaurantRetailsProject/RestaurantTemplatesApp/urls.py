...
#-------------RESET PASSWORD
    ...
    #-------------------- PRODUCTS-------------
    path('ViewRestaurantProductsPage/', views.ViewRestaurantProductsPage, name='ViewRestaurantProductsPage'),
    ...
    #----------------UPLOAD PRODUCTS----------------------------------------
    path('UploadRestaurantProductsHomePage/', views.UploadRestaurantProductsHomePage, name='UploadRestaurantProductsHomePage'),
    ...
    path('RestaurantOrderPageByProductCategory/', views.RestaurantOrderPageByProductCategory, name='RestaurantOrderPageByProductCategory'),
    path('GetRestaurantOrderPage/<int:id>/', views.GetRestaurantOrderPage, name='GetRestaurantOrderPage'),
    path('ViewRestaurantOrderItemsPageByCategory/<int:id>/', views.ViewRestaurantOrderItemsPageByCategory, name='ViewRestaurantOrderItemsPageByCategory'),
    path('DeleteRestaurantOrderByCategory/<int:id>/', views.DeleteRestaurantOrderByCategory, name='DeleteRestaurantOrderByCategory'),
    ...
    #--------------PRINT ORDERS-------------------
    path('PrintRestaurantOrders/', views.PrintRestaurantOrders, name='PrintRestaurantOrders'),
    path('PrintRestaurantOrdersByCategory/<int:id>/', views.PrintRestaurantOrdersByCategory, name='PrintRestaurantOrdersByCategory'),




    #----------UPLOAD TABLES--------------------
    path('UploadRestaurantTablesPage/', views.UploadRestaurantTablesPage, name='UploadRestaurantTablesPage'),
