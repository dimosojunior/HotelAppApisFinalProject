...
#-------------RESET PASSWORD
    ...
    #-------------------- PRODUCTS-------------
    path('ViewRetailsProductsPage/', views.ViewRetailsProductsPage, name='ViewRetailsProductsPage'),
    ...
    #----------------UPLOAD PRODUCTS----------------------------------------
    path('UploadRetailsProductsHomePage/', views.UploadRetailsProductsHomePage, name='UploadRetailsProductsHomePage'),
    ...
    path('RetailsOrderPageByProductCategory/', views.RetailsOrderPageByProductCategory, name='RetailsOrderPageByProductCategory'),
    path('GetRetailsOrderPage/<int:id>/', views.GetRetailsOrderPage, name='GetRetailsOrderPage'),
    path('ViewRetailsOrderItemsPageByCategory/<int:id>/', views.ViewRetailsOrderItemsPageByCategory, name='ViewRetailsOrderItemsPageByCategory'),
    path('DeleteRetailsOrderByCategory/<int:id>/', views.DeleteRetailsOrderByCategory, name='DeleteRetailsOrderByCategory'),
    ...
    #--------------PRINT ORDERS-------------------
    path('PrintRetailsOrders/', views.PrintRetailsOrders, name='PrintRetailsOrders'),
    path('PrintRetailsOrdersByCategory/<int:id>/', views.PrintRetailsOrdersByCategory, name='PrintRetailsOrdersByCategory'),

    #----------UPLOAD TABLES--------------------
    path('UploadRetailsTablesPage/', views.UploadRetailsTablesPage, name='UploadRetailsTablesPage'),
